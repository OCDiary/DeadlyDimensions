...
public class TileEntityShulkerBox extends TileEntityLockableLoot implements ITickable, ISidedInventory
{
    ...
    public void openInventory(EntityPlayer player)
    {
        if (!player.isSpectator())
        {
            ...
            ++this.field_190598_h;
            this.worldObj.addBlockEvent(this.pos, this.getBlockType(), 1, this.field_190598_h);

            if (this.field_190598_h == 1)
            {
                this.worldObj.playSound((EntityPlayer)null, this.pos, SoundEvents.field_191262_fB, SoundCategory.BLOCKS, 0.5F, this.worldObj.rand.nextFloat() * 0.1F + 0.9F);
            }
        }
    }
    ...
    public void closeInventory(EntityPlayer player)
    {
        if (!player.isSpectator())
        {
            ...
            if (this.field_190598_h <= 0)
            {
                this.worldObj.playSound((EntityPlayer)null, this.pos, SoundEvents.field_191261_fA, SoundCategory.BLOCKS, 0.5F, this.worldObj.rand.nextFloat() * 0.1F + 0.9F);
            }
        }
    }
