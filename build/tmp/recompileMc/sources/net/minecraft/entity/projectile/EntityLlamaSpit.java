...
public class EntityLlamaSpit extends Entity implements IProjectile
{
    ...
    public void onUpdate()
    {
        ...
        if (!this.worldObj.isMaterialInBB(this.getEntityBoundingBox(), Material.AIR))
        {
            this.setDead();
        }
    ...
    private void func_190537_j()
    {
        if (this.field_190540_b != null && this.field_190540_b.hasUniqueId("OwnerUUID"))
        {
            ...
            for (EntityLlama entityllama : this.worldObj.getEntitiesWithinAABB(EntityLlama.class, this.getEntityBoundingBox().expandXyz(15.0D)))
            {
