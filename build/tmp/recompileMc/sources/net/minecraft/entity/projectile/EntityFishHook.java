...
public class EntityFishHook extends Entity
{
    ...
    private void func_190620_n()
    {
        ...
        this.motionY = (double)MathHelper.clamp_float(-(f5 / f4), -5.0F, 5.0F);
        this.motionZ = (double)(-f2);
        float f6 = MathHelper.sqrt_double(this.motionX * this.motionX + this.motionY * this.motionY + this.motionZ * this.motionZ);
    ...
    public void notifyDataManagerChange(DataParameter<?> key)
    {
        if (DATA_HOOKED_ENTITY.equals(key))
        {
            ...
            this.caughtEntity = i > 0 ? this.worldObj.getEntityByID(i - 1) : null;
        }
    ...
    public void onUpdate()
    {
        ...
        else if (this.worldObj.isRemote || !this.func_190625_o())
        {
            if (this.inGround)
            {
                ++this.ticksInGround;
            ...
            {
                f = BlockLiquid.func_190973_f(iblockstate, this.worldObj, blockpos);
            }
            ...
            else
            {
                ...
                if (this.field_190627_av == EntityFishHook.State.BOBBING)
                {
                    ...
                    if (!this.worldObj.isRemote && f > 0.0F)
                    {
    ...
    private void func_190621_a(BlockPos p_190621_1_)
    {
        ...
        else if (this.ticksCatchableDelay > 0)
        {
            ...
            if (this.ticksCatchableDelay > 0)
            {
                ...
                double d1 = (double)((float)MathHelper.floor_double(this.getEntityBoundingBox().minY) + 1.0F);
            ...
            {
                this.motionY = (double)(-0.4F * MathHelper.randomFloatClamp(this.rand, 0.6F, 1.0F));
                ...
                this.ticksCatchable = MathHelper.getRandomIntegerInRange(this.rand, 20, 40);
            }
        }
        else if (this.ticksCaughtDelay > 0)
        {
            ...
            {
                float f6 = MathHelper.randomFloatClamp(this.rand, 0.0F, 360.0F) * 0.017453292F;
                float f7 = MathHelper.randomFloatClamp(this.rand, 25.0F, 60.0F);
                double d4 = this.posX + (double)(MathHelper.sin(f6) * f7 * 0.1F);
                double d5 = (double)((float)MathHelper.floor_double(this.getEntityBoundingBox().minY) + 1.0F);
